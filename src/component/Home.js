                    ...
                    <ul>
                        <li>
                            <dl>
                                ...
                                <dd>
                                    <span>个人信息:</span>朱长龙 / 男 / 29岁
                                </dd>
                                <dd>
                                    <span>毕业院校:</span>承德石油高专
                                </dd>
                                <dd>
                                    <span>个人专业:</span>数控技术
                                </dd>
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <a href="https://webzcl.github.io/myblog">https://webzcl.github.io/myblog</a>
                                </dd>
                                <dd>
                                    <span>
                                    ...
                                    <a href="https://github.com/webzcl">https://github.com/webzcl</a>
                                </dd>
                                <dd>
                                    <span>
                                    ...
                                    <a href="https://webzcl.github.io/">https://webzcl.github.io/</a>
                                </dd>
                                <dd>
                                    <span>
                                ...
                                <dd className="detail-skill">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <p>能使用ES6语法和React库进行模块化的开发，能实现基本的页面布局和常见的功能，轮播，TODOMVC等。掌握了 React-router实现页面的无刷新体验 、axios或者JQ 来实现Ajax请求数据实现页面的局部刷新等等。 </p>
                                        </li>
                                    </ul>
                                </dd>
                            </dl>
